...
class Faith: commonItems::parser
{
  ...
  private:
   ...
   std::vector<std::string> doctrines;  // This is a vector in order to keep order consistent. We want the first things
                                        // read (tenets) to be the first things output, ALWAYS
