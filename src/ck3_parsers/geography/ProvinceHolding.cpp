...
{
   registerKeyword("holding", [this](const std::string&, std::istream& theStream) {
   ...
   registerKeyword("type", [this](const std::string&, std::istream& theStream) {
      holdingType = commonItems::singleString(theStream).getString();
   });
   registerKeyword("special_building_type", [this](const std::string&, std::istream& theStream) {
      specialBuilding = commonItems::singleString(theStream).getString();
   });
   registerKeyword("buildings", [this](const std::string&, std::istream& theStream) {
