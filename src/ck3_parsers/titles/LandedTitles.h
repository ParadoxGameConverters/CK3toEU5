...
class LandedTitles: commonItems::parser
{
  public:
   ...
   void linkProvinceHoldings(const ProvinceHoldings& province_holdings_);
  ...
  private:
   ...
   // This is of questionable use as savegame already defines defacto capitals. Not always present, and if present then
   // a COUNTY.
