...
void mappers::LocalizationMapper::scrapeLocalizations(const std::filesystem::path& ck3Path, const Mods& mods)
{
	scrapeLanguage("english", ck3Path / "localization");
	scrapeLanguage("french", ck3Path / "localization");
	scrapeLanguage("german", ck3Path / "localization");
	scrapeLanguage("korean", ck3Path / "localization");
	scrapeLanguage("russian", ck3Path / "localization");
	scrapeLanguage("simp_chinese", ck3Path / "localization");
	scrapeLanguage("spanish", ck3Path / "localization");
